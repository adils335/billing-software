...
use app\models\Search\CompanyAddresses as CompanyAddressesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CompanyAddressesController implements the CRUD actions for CompanyAddresses model.
 */
class CompanyAddressesController extends Controller
{
    ...
    {
        $searchModel = new CompanyAddressesSearch();
    ...
    {
        if (($model = CompanyAddresses::findOne(['id' => $id])) !== null) {
            return $model;
        }
