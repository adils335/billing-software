    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Account <strong class="pull-right"><?= $model->name?></strong></h4>
        </div>
        <div class="modal-body">
            <div class="row">

                <?= $form->field($account, 'worker_vendor_id')->hiddenInput(['value' => $model->id])->label(false); ?>
