    ...
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <?= $form->field($model, 'inout_type')->widget(Select2::classname(), [
                     'data' => \app\models\SiteDues::buildBalanceType(),
                     'options' => ['placeholder' => 'Select ...'],
                     'pluginOptions' => [
                              'allowClear' => true
                      ],
        ...
        <div class="col-md-2">
          ...
          <?= $form->field($model, 'status')->widget(Select2::classname(), [
                     'data' => \app\models\SiteDues::buildStatus(),
                     'options' => ['placeholder' => 'Select ...'],
                     'pluginOptions' => [
                              'allowClear' => true
                      ],
...
$formatJs = <<< JS
  ...
  $('#sitedues-state_id').change(function(){
	  
	  var state = $(this).val();
	  var district = $("#sitedues-district_id");
