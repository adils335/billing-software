    ...
    <div class="row">
       ...
       <div class="col-md-12">    
          ...
          <div class="form-group">
              ...
              <?= Html::a(Yii::t('app', 'Paid Gst'),['gst-paid'], ['class' => 'btn btn-info']) ?>
              <?= Html::a(Yii::t('app', 'Hsn wise Gst'),['gst-hsnwise'], ['class' => 'btn btn-warning']) ?>
              <?= Html::a(Yii::t('app', 'Purchase Gst'),['gst-purchase'], ['class' => 'btn btn-danger']) ?>
              <?= Html::a(Yii::t('app', 'Bill Report'),['gst-bill'], ['class' => 'btn btn-success']) ?>
              <?= Html::a(Yii::t('app', 'Payable GST'),['gst-payable'], ['class' => 'btn btn-primary']) ?>
          </div>
