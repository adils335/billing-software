...
?>
<div class="store-consumed-view box box-primary"> 
    ...
    <span class="pull-right">
        ...
        <br>
        <div class="row">
            <div class="col-md-4"><strong>Invoice Number: </strong> <?= $model->invoice_no?></div>
            <div class="col-md-4"><strong>Bill Number: </strong> <?= $model->bill_no?></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4"><strong>Invoice Date : </strong> <?= Yii::$app->formatter->asDate($model->invoice_date,'php:d-m-Y')?></div>
        </div>
        ...
        <div class="row store-indents-items">             
            <table class="table store-indents-items-body">
                ...
                <tbody>
                    <?php
                    $sn = 1; 
                    foreach($model->storeConsumedItems as $Item):
                    ?>
                    <tr>
                    <td><?= $sn++;?></td>
