...
?>
	...
	<?php 
	if($billDeduction->isNewRecord){?>
	
	<div class="row clone">
	    
	    <div class="col-sm-2">
           <button type="button" class="remove-item-2 btn btn-danger btn-xs"><i class="glyphicon glyphicon-minus"></i></button>
		</div>
	    ...
	    <div class="col-sm-1">
	        <?= $form->field($billDeduction, 'is_rate[]')->checkbox(['value' => "1",'checked'=>'checked','class'=>'is_rate'])->label(false); ?>
		</div>
	...
	<div class="row deduction-total">
	    <div class="col-sm-8">
		   <button type="button" class="add-item-2 btn btn-info"><i class="glyphicon glyphicon-plus"></i>Add</button>
	    </div>
	    <div class="col-sm-2">
