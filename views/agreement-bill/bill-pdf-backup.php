...
<html lang="en">
  ...
  <body>
		...
		<table class="main-table">
			 ...
			 <tr>
			     <td colspan="6" class="l-text text-red sf">
			         <span>
			     ...
			     <td colspan="6" class="r-text sf">Email : <span><?= $model->company->email?></span></td>
			 </tr>
			 ...
			 <tr>
			     ...
			     <td colspan="3" class="l-text text-blue sf">Mobile No : <span><?= $model->company->number?></span></td>
			 </tr>
			 ...
			 <tr>
			     <td colspan="6" class="m-text sf text-blue"><span>Bill To Party</span></td>
			     <td colspan="6" class="m-text sf text-blue"><span>Ship To Party</span></td>
			 </tr>
		
			 <tr>
			     <td colspan="6" class="l-text sf">
			         ...
			         <span><?= $model->agreement->contractCompany->name."/".$model->agreement->contractCompanyDistrict->district?></span>
			         <?php $i = intval(strlen($billToParty)/34);?>
			     </td>
			     <td colspan="6" class="l-text sf">
			         <span class="text-blue">Name/Address : </span>
			         <?php $shipToParty = $model->billingCompany->name."/".$model->billingCompanyDistrict->district;?>
			         <span><?= $shipToParty?></span>
			         <?php $j = intval(strlen($shipToParty)/34);
			         $i = $i>$j?$i:$j;
			         ?>
			     </td>
			 </tr>
			 ...
			 <tr>
			     <td colspan="3" class="l-text sf text-red w30">GSTIN: <span><?= $model->agreement->contract_company_gst?></span></td>
			     <td colspan="3" class="l-text sf text-blue w20">State: <span><?= $model->agreement->contractCompanyState->state?></span></td>
			     <!--<td colspan="1" class="l-text sf text-blue">Code : <span><?= $model->agreement->contractCompanyState->state_tin?></span></td>-->
			     <td colspan="3" class="l-text sf text-red w30">GSTIN: <span><?= $model->billing_company_gst?></span></td>
			     <td colspan="3" class="l-text sf text-blue w20">State: <span><?= $model->billingCompanyState->state?></span></td>
			     <!--<td colspan="1" class="l-text sf text-blue">Code : <span><?= $model->billingCompanyState->state_tin?></span></td>-->
			 </tr>
		
			 <tr>
			     <td colspan="6" class="l-text sf">
			         <?php if($model->work_name):?>
			         <span class="text-blue">Name of Work : </span>
			         <span><?= $model->work_name?></span>
			         <?php $i+= intval(strlen($model->work_name)/34);?>
			         <?php endif;?>
			     </td>
			     <td colspan="3" class="l-text sf">
			 ...
			 <tr>
			     <td colspan="6" class="l-text sf">
			         <?php if($model->section_name):?>
			         <span class="text-blue">Name of Section :</span>
			         <span><?= $model->section_name?></span>
			         <?php $j = intval(strlen($model->section_name)/34);?>
			         <?php endif;?>
			     </td>
			     <td colspan="6" class="l-text sf">
			         <?php if($model->agreement->agreement_no):?>
			         <span class="text-blue">Agreement No :</span>
			         <span><?= $model->agreement->agreement_no?></span>
			         <?php $k = intval(strlen($model->agreement->agreement_no)/34);?>
			         <?php $i += $j>$k?$j:$k;?>
			         <?php endif;?>
			     </td>
			 </tr>
			 ...
			 <tr>
			     <td colspan="6" class="l-text sf">
			         ...
			         <span class="text-blue">Work Order No :</span>
			         <span><?= $model->order_no?></span>
			         <?php $j = intval(strlen($model->order_no)/34);?>
			         <?php endif;?>
			     </td>
			     <td colspan="6" class="l-text sf">
			         <?php if($model->estimate_no):?>
			         <span class="text-blue">Estimate No :</span>
			         <span><?= $model->estimate_no?></span>
			         <?php $j = intval(strlen($model->estimate_no)/34);?>
			         <?php $i += $j>$k?$j:$k;?>
			         <?php endif;?>
			     </td>
			 </tr>
			 ...
			 <tr>
			     ...
			     <td colspan="6" class="l-text sf w40 text-blue">Product Description</td>
			     <td colspan="1" class="m-text sf w10 text-blue">HSN/SAC</td>
			     <td colspan="1" class="m-text sf w8 text-blue">UOM</td>
			     <td colspan="1" class="r-text sf w8 text-blue">Qty</td>
			     <td colspan="1" class="r-text sf w8 text-blue">Rate</td>
			     <td colspan="1" class="r-text sf w12 text-blue">Amount</td>
			 </tr>
			 ...
			 <tr class="item">
			     ...
			     <td colspan="6" class="l-text sf"><?= htmlspecialchars($item->itemName->item);?></td>
