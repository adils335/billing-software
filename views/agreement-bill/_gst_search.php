    ...
    <div class="row">
       ...
       <div class="col-md-12">    
          ...
          <div class="form-group">
              ...
              <?= Html::button(Yii::t('app', 'Paid Gst'), ['class' => 'btn btn-info','onclick'=>"$(form).attr('action','gst-paid');$(form).submit();"]) ?>
              <?//= Html::button(Yii::t('app', 'Total Invoice'), ['class' => 'btn btn-info','onclick'=>"$(form).attr('action','gst-total-invoice');$(form).submit();"]) ?>
              <?= Html::button(Yii::t('app', 'Hsn wise Gst'), ['class' => 'btn btn-warning','onclick'=>"$(form).attr('action','gst-hsnno');$(form).submit();"]) ?>
              <?= Html::button(Yii::t('app', 'Purchase Gst'), ['class' => 'btn btn-danger','onclick'=>"$(form).attr('action','gst-purchase');$(form).submit();"]) ?>
              <?= Html::button(Yii::t('app', 'Bill Report'), ['class' => 'btn btn-success','onclick'=>"$(form).attr('action','gst-bill');$(form).submit();"]) ?>
              <?= Html::button(Yii::t('app', 'Payable GST'), ['class' => 'btn btn-primary','onclick'=>"$(form).attr('action','gst-payable');$(form).submit();"]) ?>
              <?//= Html::submitButton(Yii::t('app', 'Generate Pdf'), ['class' => 'btn btn-info','name'=>'generate-pdf','value'=>1]) ?>
          </div>
