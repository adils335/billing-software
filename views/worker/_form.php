...
<div class="worker-vendor-form">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <?= $form->field($model, 'inout_type')->widget(Select2::classname(), [
                     'data' => \app\models\WorkerVendor::buildBalanceType(),
                     'options' => ['placeholder' => 'Select ...'],
                     'pluginOptions' => [
                              'allowClear' => true
                      ],
        ...
        <div class="col-md-2">
          ...
          <?= $form->field($model, 'status')->widget(Select2::classname(), [
                     'data' => \app\models\WorkerVendor::buildStatus(),
                     'options' => ['placeholder' => 'Select ...'],
                     'pluginOptions' => [
                              'allowClear' => true
                      ],
    ...
    <div class="row">
        ...
        <div class="col-md-2">
          ...
          <?= $form->field($model, 'is_deduction')->widget(Select2::classname(), [
                     'data' => \app\models\Worker::buildDeduction(),
                     'options' => ['placeholder' => 'Select ...'],
                     'pluginOptions' => [
                              'allowClear' => true
                      ],
...
$formatJs = <<< JS
  ...
  $('#workervendor-state_id').change(function(){
	  
	  var state = $(this).val();
	  var district = $("#workervendor-district_id");
