...
?>
<div class="store-indents-view box box-primary"> 
    ...
    <div class="row">
        ...
        <div class="col-md-4"><strong>Indent Date : </strong> <?= Yii::$app->formatter->asDate($model->indent_date,'php:d-m-Y')?></div>
    ...
    <div class="row store-indents-items">             
        <table class="table store-indents-items-body">
            ...
            <tbody>
                <?php
                $sn = 1; 
                foreach($model->storeIndentsItems as $Items):
                ?>
                <tr>
                <td><?= $sn++;?></td>
                <td><?= $Items->storeProducts->name;?></td>
                <td><?= $Items->uom->name;?></td>
