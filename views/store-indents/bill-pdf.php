...
<html lang="en">
    ...
    <table class="main-table">
        ...
        <tr>
            <td colspan="4" class="l-text text-red">
                <span>
        ...
        <tr>
            ...
            <td colspan="3" class="l-text text-red">GST No : <span><?= $model->company->gst_no?></span></td>
            <td colspan="3" class="l-text text-blue">State : <span><?= $model->state->state?></span></td>
            <td colspan="2" class="l-text text-blue">Code : <span><?= $model->state->state_tin?></span></td>
            
        </tr>
        <tr>
            <td colspan="3" class="l-text text-blue lf"></td>
            <td colspan="5" class="l-text text-blue lf">Indent No : <span><?= $model->session."/"?></span><span class="text-red"><?= sprintf("%02d",$model->indent_no)?></span></td>
            <td colspan="4" class="l-text text-blue mf">Date : <span><?= $formatter->asDate($model->indent_date,'php:d-m-Y')?></span></td>
        </tr>
        
        <tr>
            <td colspan="12" class="m-text mf text-blue"><span>Store Indents</span></td>
        </tr>
