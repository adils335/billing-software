...
<?php DynamicFormWidget::begin([
        ...
        'model' => $modelsStoreIndentsItems[0],
        'formId' => 'DynamicForm',
        'formFields' => [
            'store_products_id',
            'uom_id',
    ...
    <div class="container-items"><!-- widgetContainer -->
        <?php foreach ($modelsStoreIndentsItems as $index => $modelStoreIndentsItems): ?>
            <div class="item panel"><!-- widgetBody -->
                    <?php
                        // necessary for update action.
                        if (!$modelStoreIndentsItems->isNewRecord) {
                            echo Html::activeHiddenInput($modelStoreIndentsItems, "[{$index}]id",['class'=>'item_id']);
                        }
                    ?>

                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-4">
                        <?= $form->field($modelStoreIndentsItems, "[{$index}]store_products_id")->widget(Select2::classname(), [
                        ...
                        <?= $form->field($modelStoreIndentsItems, "[{$index}]uom_id")->widget(Select2::classname(), [
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-4">
                            <?= $form->field($modelStoreIndentsItems, "[{$index}]quantity") ?>
                        </div>
