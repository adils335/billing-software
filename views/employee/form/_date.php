    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Joining and End Date <strong class="pull-right"><?= $model->emp_name?></strong></h4>
        </div>
        <div class="modal-body">
            <div class="row">

                <?= $form->field($erpmeta, 'type')->hiddenInput(['value' => $erpmeta::TYPE_EMPLOYEE])->label(false); ?>
