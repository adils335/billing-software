...
<html lang="en">
    ...
    <table class="main-table">
        ...
        <tr>
            <td colspan="1" class="l-text text-blue mf">State : <span><?= $model->state->state?></span></td>
            <td colspan="1" class="l-text text-blue mf">Code : <span><?= $model->state->state_tin?></span></td>
            <td colspan="4" class="l-text text-blue lf">Indent No : <span><?= $model->session."/"?></span><span class="text-red"><?= sprintf("%02d",$model->indent_no)?></span></td>
            <td colspan="3" class="l-text text-blue lf">Gate Pass No : <?= $model->gate_pass_no?></span></td>
            <td colspan="3" class="l-text text-blue mf">Date : <span><?= $formatter->asDate($model->date,'php:d-m-Y')?></span></td>
        </tr>
        
        <tr>
            <td colspan="12" class="m-text mf text-blue"><span>Store Issue</span></td>
        </tr>

        <tr>
            <td colspan="5" class="l-text text-blue">TO:-<span><?= $model->billingCompany->name?></span></td>
        ...
        <tr class="bg-blue">
            <td colspan="2" class="m-text">S.No</td>
            <td colspan="4" class="m-text">Name Of Items</td>
            <td colspan="3" class="m-text">UOM</td>
            <td colspan="3" class="m-text ">Qty</td>
        </tr>
        ...
        <tr class="item">
            <td colspan="2" class="m-text"><?= $sn++;?></td>
            <td colspan="4" class="m-text"><?= $item->storeProducts->name;?></td>
            <td colspan="3" class="m-text"><?= $item->uom->name;?></td>
            <td colspan="3" class="m-text"><?= $item->quantity;?></td>
        </tr>
