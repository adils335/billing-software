...
/**
 * This is the base-model class for table "agreement_tax".
 *
 * @property integer $id
 ...
 * @property \app\models\BillTax $billTax
 * @property \app\models\Company $company
 * @property \app\models\Tax $tax
 * @property string $aliasModel
 */
abstract class AgreementTax extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['agreement_id', 'tax_id', 'rate', 'company_id', 'session'], 'required'],
            [['agreement_id', 'tax_id', 'company_id'], 'integer'],
            [['rate'], 'number'],
    ...
    {
        return $this->hasOne(\app\models\BillTax::className(), ['tax_id' => 'tax_id','agreement_id'=>'agreement_id']);
    }
