...
/**
 * This is the base-model class for table "bill_penality".
 *
 * @property integer $id
 ...
 */
abstract class BillPenality extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['invoice_id', 'agreement_id', 'company_id', 'session'], 'required'],
            [['invoice_id', 'agreement_id', 'tax_id', 'company_id'], 'integer'],
            [['amount'], 'number'],
