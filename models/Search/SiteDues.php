...
use app\models\SiteDues as SiteDuesModel;

/**
 * SiteDues represents the model behind the search form of `app\models\SiteDues`.
 */
class SiteDues extends SiteDuesModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = SiteDuesModel::find();
        $query->andWhere(['!=','status',SiteDuesModel::STATUS_DELETE]);
