...
/**
 * Worker represents the model behind the search form of `app\models\Worker`.
 */
class Worker extends WorkerModel
{
    ...
    {
        return [
            [['id', 'code', 'state_id', 'district_id', 'worker_vendor_id', 'inout_type', 'status', 'company_id', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
