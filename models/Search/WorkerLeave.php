...
use app\models\WorkerLeave as WorkerLeaveModel;

/**
 * WorkerLeave represents the model behind the search form of `app\models\WorkerLeave`.
 */
class WorkerLeave extends WorkerLeaveModel
{
    public $session;
    public $from_date;
    public $to_date;
    ...
    {
        return [
            [['id', 'worker_id', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
            [['month', 'leave', 'comments','worker_vendor_id','session','from_month','to_month','from_date','to_date'], 'safe'],
        ];
    }
